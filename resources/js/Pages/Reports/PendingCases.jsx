        ...
        <AuthenticatedLayout title="Pending Cases Report">
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                    <Link
                        href="/reports"
                        className="p-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white shadow-2xs transition"
                    >
                                    ...
                                    cases.data.map((c, idx) => (
                                        <tr key={idx} className="hover:bg-slate-50/80 dark:hover:bg-slate-900/40 transition">
                                            ...
                                            <td className="py-3 px-4 text-right">
                                                <Link
                                                    href={`/inward/${c.id}`}
                                                    className="inline-flex items-center gap-1 text-[11px] font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 bg-indigo-50 dark:bg-indigo-500/10 px-2.5 py-1 rounded-lg border border-indigo-200 dark:border-indigo-500/20"
                                                >
