        ...
        <AuthenticatedLayout title={`Calculation - ${case_data.registration_no}`}>
            ...
            <div className="space-y-6 max-w-7xl mx-auto pb-16">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className="text-xs px-2.5 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-300 border border-indigo-200 dark:border-indigo-500/20 font-mono font-semibold">
                                    {case_data.registration_no}
                                </span>
                            </div>
                            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                Subscriber: <strong className="text-slate-800 dark:text-slate-200">{case_data.subscriber_name_cache}</strong> | GPF A/C:{' '}
                                <strong className="text-indigo-600 dark:text-indigo-300 font-mono">{case_data.formatted_gpf_account}</strong> | Case Type:{' '}
                                <span className="text-slate-700 dark:text-slate-300 font-medium">{case_data.case_type}</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white text-xs font-semibold transition shadow-2xs"
                        ...
                        <button
                            ...
                            onClick={submit}
                            disabled={isSaving}
                            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-500 hover:to-indigo-400 text-white text-xs font-semibold shadow-md shadow-indigo-600/25 transition disabled:opacity-50"
                        >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-6 gap-3">
                    <div className="glass-panel app-card p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 shadow-sm">
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Base Opening Balance</div>
                        ...
                        <div className="text-[10px] text-indigo-600 dark:text-indigo-400 mt-0.5 font-medium">{finYear} (VLC)</div>
                    </div>
                    <div className="glass-panel app-card p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 shadow-sm">
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Total Subscriptions</div>
                        ...
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">Regular Deposits</div>
                    </div>
                    <div className="glass-panel app-card p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 shadow-sm">
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Total Withdrawals</div>
                        <div className="text-sm font-bold text-rose-600 dark:text-rose-400 mt-1 font-mono">
                            - ₹ {Number(liveCalculations.total_withdrawals).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                        </div>
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">Debit Adjustments</div>
                    </div>
                    <div className="glass-panel app-card p-3.5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 shadow-sm">
                        <div className="text-[11px] text-slate-500 dark:text-slate-400 font-medium">Accrued Interest</div>
                        ...
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 mt-0.5">Normal Period</div>
                    </div>
                    <div className="glass-panel app-card p-3.5 rounded-2xl border border-amber-200 dark:border-amber-500/30 bg-amber-50/70 dark:bg-amber-950/10 shadow-sm">
                        ...
                        <div className="text-sm font-bold text-amber-700 dark:text-amber-400 mt-1 font-mono">
                            + ₹ {Number(liveCalculations.delay_interest).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                        </div>
                        <div className="text-[10px] text-amber-700/80 dark:text-amber-400/80 mt-0.5 font-medium">
                            {liveCalculations.has_delay ? `${liveCalculations.delay_rows.length} Delay Month(s)` : 'No Delay'}
                        </div>
                    </div>
                    <div className="glass-panel app-card p-3.5 rounded-2xl bg-gradient-to-r from-emerald-50 to-indigo-50 dark:from-emerald-950/40 dark:to-indigo-950/40 border border-emerald-200 dark:border-emerald-500/30 col-span-2 sm:col-span-1 shadow-sm">
                        <div className="text-[11px] text-emerald-800 dark:text-emerald-300 font-semibold">Net GPF Settlement</div>
                        <div className="text-base font-extrabold text-emerald-700 dark:text-emerald-400 mt-1 font-mono">
                ...
                <div className="glass-panel app-card p-4.5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 shadow-sm">
                            ...
                            <div>
                                <h3 className="text-sm font-bold text-slate-900 dark:text-white flex flex-wrap items-center gap-2">
                                    ...
                                    {available_base_years && available_base_years.some(b => Number(b.closing_balance) > 0) ? (
                                        <span className="text-[10px] px-2 py-0.5 rounded bg-emerald-50 dark:bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/20 font-mono font-medium">
                                            ✓ Direct from VLCS.GP_YEARLY_BALANCES ({available_base_years.length} FYs)
                                        </span>
                                    ) : (
                                        <span className="text-[10px] px-2 py-0.5 rounded bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/20 font-mono flex items-center gap-1 font-medium">
                                ...
                                {available_base_years && !available_base_years.some(b => Number(b.closing_balance) > 0) && (
                                    <p className="text-[11px] text-amber-700 dark:text-amber-400/90 mt-1 flex items-center gap-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
                            <div className="w-full sm:w-72">
                                ...
                                <select
                                    ...
                                    className="w-full px-3 py-2 bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-xs text-slate-900 dark:text-slate-100 font-mono font-semibold shadow-2xs focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                                >
                            ...
                            <div className="w-full sm:w-48">
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                    className={`w-full px-3 py-2 bg-white dark:bg-slate-900 border rounded-xl text-xs text-slate-900 dark:text-slate-100 font-mono font-bold shadow-2xs focus:ring-1 ${
                                        Number(openingBal) === 0
                                            ? 'border-amber-400 dark:border-amber-500/50 focus:border-amber-500 focus:ring-amber-500'
                            ...
                            <div className="flex items-end self-end pt-5 gap-2">
                                <button
                                    ...
                                    className="px-3.5 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-indigo-700 dark:text-indigo-400 text-xs font-semibold flex items-center gap-1.5 transition border border-slate-200 dark:border-slate-700 shadow-2xs"
                                ...
                                <button
                                    type="button"
                                    onClick={() => addRow(true)}
                                    className="px-3.5 py-2 rounded-xl bg-amber-50 hover:bg-amber-100 dark:bg-amber-500/10 dark:hover:bg-amber-500/20 text-amber-800 dark:text-amber-400 text-xs font-semibold flex items-center gap-1.5 transition border border-amber-200 dark:border-amber-500/30 shadow-2xs"
                    ...
                    {liveCalculations.grouped_normal_fy.map((group) => (
                        <div key={group.financial_year} className="space-y-4">
                            ...
                            <div className="flex items-center justify-between px-1">
                                <div className="flex items-center gap-2.5">
                                    <div className="w-2.5 h-2.5 rounded-full bg-indigo-600 dark:bg-indigo-500"></div>
                                    <h3 className="text-sm font-bold text-slate-900 dark:text-white uppercase tracking-wider font-mono">
                                        Calculation for Financial Year: {group.financial_year}
                                    </h3>
                                    <span className="text-[11px] px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-mono font-medium border border-slate-200 dark:border-slate-700">
                                        Opening: ₹ {Number(group.opening_balance).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                    </span>
                                </div>
                                <div className="text-xs text-slate-600 dark:text-slate-400 font-mono">
                                    Year-End Closing: <strong className="text-indigo-600 dark:text-indigo-400">₹ {Number(group.closing_balance).toLocaleString('en-IN')}</strong>
                                </div>
                            </div>

                            {/* FY Monthly Table */}
                            <div className="glass-panel app-card rounded-2xl overflow-hidden shadow-sm border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80">
                                <div className="overflow-x-auto">
                                    <table className="w-full text-left text-xs">
                                        <thead className="bg-slate-50 dark:bg-slate-900/90 border-b border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 font-semibold uppercase tracking-wider text-[11px]">
                                            <tr>
                                        ...
                                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800/60 font-mono">
                                            {group.rows.map((row) => {
                                                ...
                                                let rowBg = 'hover:bg-slate-50/80 dark:hover:bg-slate-900/40';
                                                if (isCut) {
                                                    if (earnsInt) {
                                                        rowBg = 'bg-emerald-50/80 hover:bg-emerald-100/60 dark:bg-emerald-950/30 dark:hover:bg-emerald-950/40 text-emerald-900 dark:text-emerald-200 border-l-4 border-emerald-500';
                                                    } else {
                                                        rowBg = 'bg-rose-50/80 hover:bg-rose-100/60 dark:bg-rose-950/40 dark:hover:bg-rose-950/50 text-rose-900 dark:text-rose-200 border-l-4 border-rose-500';
                                                    }
                                                } else if (noInt) {
                                                    rowBg = 'bg-cyan-50/60 hover:bg-cyan-100/40 dark:bg-cyan-950/20 dark:hover:bg-cyan-950/30 text-cyan-900 dark:text-cyan-200';
                                                }
                                                    ...
                                                    <tr key={originalIndex} className={`${rowBg} transition`}>
                                                        <td className="py-2 px-3">
                                                            <div className="flex items-center gap-1.5">
                                                                <input
                                                                    ...
                                                                    className="px-2 py-1 bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded text-[11px] text-slate-800 dark:text-slate-200 font-mono shadow-2xs"
                                                                />
                                                                ...
                                                                {isCut && (
                                                                    earnsInt ? (
                                                                        <span className="px-1.5 py-0.5 rounded bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-300 dark:border-emerald-500/30 text-[9px] font-sans font-bold uppercase" title="Month-end Superannuation: Entitled to full interest">
                                                                            Retirement Month (Interest Admissible)
                                                                        </span>
                                                                    ) : (
                                                                        <span className="px-1.5 py-0.5 rounded bg-rose-100 dark:bg-rose-500/20 text-rose-800 dark:text-rose-300 border border-rose-300 dark:border-rose-500/30 text-[9px] font-sans font-bold uppercase" title="Cut Month: Interest suppressed">
                                                        ...
                                                        <td className="py-2 px-3 text-right">
                                                            <input
                                                                ...
                                                                className="w-24 px-2 py-1 bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded text-right text-emerald-600 dark:text-emerald-400 font-semibold text-xs shadow-2xs"
                                                            />
                                                        </td>
                                                        <td className="py-2 px-3 text-right">
                                                            <input
                                                                ...
                                                                className="w-24 px-2 py-1 bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded text-right text-rose-600 dark:text-rose-400 font-semibold text-xs shadow-2xs"
                                                            />
                                                        </td>
                                                        <td className="py-2 px-3 text-right">
                                                            <input
                                                                ...
                                                                className="w-16 px-1.5 py-1 bg-white dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800 rounded text-right text-slate-800 dark:text-slate-300 text-xs shadow-2xs"
                                                            />
                                                        </td>
                                                        <td className="py-2 px-3 text-center">
                                                            <input
                                                                ...
                                                                className="rounded bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 text-indigo-600 focus:ring-0 cursor-pointer shadow-2xs"
                                                                title="Toggle interest eligibility"
                                                            />
                                                        </td>
                                                        <td className="py-2 px-3 text-right text-slate-900 dark:text-slate-200 font-semibold">
                                                        ...
                                                        <td className="py-2 px-3 text-center">
                                                            <input
                                                                ...
                                                                className="rounded bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 text-rose-600 focus:ring-0 cursor-pointer shadow-2xs"
                                                        ...
                                                        <td className="py-2 px-2 text-center">
                                                            <button
                                                                ...
                                                                className="p-1 rounded text-slate-400 hover:text-rose-600 dark:text-slate-500 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-500/10 transition"
                                        ...
                                        {/* FY Totals Footer */}
                                        <tfoot className="bg-slate-50/90 dark:bg-slate-900/90 font-mono font-bold border-t border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-200">
                                            <tr>
                                                <td className="py-3 px-3 uppercase text-[11px] text-slate-600 dark:text-slate-400">
                                                ...
                                                <td colSpan={3} className="py-3 px-3 text-right text-slate-500 dark:text-slate-400 text-[11px]">
                                                    Interest Sum:
                                                </td>
                                                ...
                                                <td colSpan={2} className="py-3 px-3 text-center text-emerald-700 dark:text-emerald-400 text-xs">
                ...
                {liveCalculations.has_delay && (
                    <div className="space-y-4 pt-4">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 px-1">
                            <div className="flex items-center gap-2.5">
                                <div className="p-1.5 rounded-lg bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-500/30">
                                    <AlertTriangle className="w-4 h-4" />
                                </div>
                                <h3 className="text-sm font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wider font-mono">
                                    DELAY INTEREST CALCULATION (Months After Cut-Off)
                                </h3>
                                <span className="text-[11px] px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-500/10 text-amber-800 dark:text-amber-300 border border-amber-200 dark:border-amber-500/20 font-mono">
                        ...
                        {liveCalculations.has_exceeded_delay_cap && (
                            !delayRemarks.trim() ? (
                                <div className="p-4 rounded-2xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 text-amber-900 dark:text-amber-200 flex items-start gap-3 shadow-sm">
                                    ...
                                    <div className="space-y-1 text-xs">
                                        <div className="font-bold text-amber-900 dark:text-amber-300 flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] px-2 py-0.5 bg-rose-100 dark:bg-rose-500/20 text-rose-800 dark:text-rose-300 border border-rose-200 dark:border-rose-500/30 rounded-full font-mono">
                                                Months 7+ Capped at ₹0.00
                                            </span>
                                        </div>
                                        <p className="text-amber-800 dark:text-amber-200/80 leading-relaxed">
                                            This case contains <strong className="text-slate-900 dark:text-white">{liveCalculations.delay_rows.length} delayed months</strong>. Under Rule 11(4) of Central GPF Rules 1960, interest on delayed final payment is capped at 6 months. To allow interest for months 7+, the officer must provide a formal <strong>Delay Justification / Remarks</strong> below explaining why the delay was beyond the subscriber's control.
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                <div className="p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/30 text-emerald-900 dark:text-emerald-200 flex items-start gap-3 shadow-sm">
                                    ...
                                    <div className="space-y-1 text-xs">
                                        <div className="font-bold text-emerald-900 dark:text-emerald-300 flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] px-2 py-0.5 bg-emerald-100 dark:bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-500/30 rounded-full font-mono">
                                                All {liveCalculations.delay_rows.length} Months Unlocked
                                            </span>
                                        </div>
                                        <p className="text-emerald-800 dark:text-emerald-200/80 leading-relaxed">
                                            Administrative justification recorded. Delay interest is computed for all {liveCalculations.delay_rows.length} months.
                                            {delay_approved_by && (
                                                <span className="block mt-1 text-[11px] text-emerald-700 dark:text-emerald-400 font-mono">
                        ...
                        <div className="glass-panel app-card p-4.5 rounded-2xl border border-amber-200 dark:border-amber-500/30 bg-white dark:bg-slate-900/60 space-y-2 shadow-sm">
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                                <label className="text-xs font-bold text-amber-800 dark:text-amber-300 flex items-center gap-2 font-mono">
                                    <span>Administrative Delay Justification / Remarks</span>
                                    {liveCalculations.has_exceeded_delay_cap && !delayRemarks.trim() ? (
                                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-rose-100 dark:bg-rose-500/20 text-rose-800 dark:text-rose-300 border border-rose-200 dark:border-rose-500/30 font-sans font-semibold">
                                            Required to unlock months 7+
                                        </span>
                                    ) : (
                                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 font-sans font-medium">
                                ...
                                {delay_approved_by && (
                                    <span className="text-[11px] text-slate-500 dark:text-slate-400 font-mono">
                                        Sanctioned by: <span className="text-indigo-600 dark:text-indigo-300 font-semibold">{delay_approved_by}</span> ({delay_approved_at})
                                    </span>
                                )}
                            </div>
                            <textarea
                                ...
                                className="w-full px-3 py-2 bg-white dark:bg-slate-950/80 border border-slate-300 dark:border-slate-700 focus:border-amber-500 rounded-xl text-xs text-slate-900 dark:text-slate-200 placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none transition font-sans shadow-2xs"
                            />
                        </div>

                        <div className="glass-panel app-card rounded-2xl overflow-hidden shadow-sm border border-amber-200 dark:border-amber-500/30 bg-white dark:bg-amber-950/10">
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-xs">
                                    <thead className="bg-amber-50/80 dark:bg-amber-950/40 border-b border-amber-200 dark:border-amber-500/20 text-amber-900 dark:text-amber-200/90 font-semibold uppercase tracking-wider text-[11px]">
                                        <tr>
                                            ...
                                            <th className="py-3 px-3 text-right">Rate %</th>
                                            <th className="py-3 px-3 text-right">Progressive (₹)</th>
                                            <th className="py-3 px-3 text-right text-amber-800 dark:text-amber-300">Delay Int (₹)</th>
                                            <th className="py-3 px-3 text-center" title="Set this month as the Cut Month">Set Cut Month</th>
                                            <th className="py-3 px-2 text-center">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-amber-100 dark:divide-amber-500/10 font-mono">
                                        {liveCalculations.delay_rows.map((row) => {
                                            const originalIndex = row._rowIndex;

                                            return (
                                                <tr key={originalIndex} className="hover:bg-amber-50/50 dark:hover:bg-amber-950/20 transition">
                                                    <td className="py-2 px-3">
                                                        <div className="flex items-center gap-1.5 flex-wrap">
                                                            <input
                                                                ...
                                                                value={row.pay_slip_date}
                                                                onChange={(e) => updateRow(originalIndex, 'pay_slip_date', e.target.value)}
                                                                className="px-2 py-1 bg-white dark:bg-slate-950/70 border border-amber-200 dark:border-amber-500/30 rounded text-[11px] text-amber-900 dark:text-amber-200 font-mono shadow-2xs"
                                                            />
                                                            <span className="text-[10px] text-amber-600 dark:text-amber-400/70 font-sans">
                                                                M{row.accounting_month}
                                                            </span>
                                                    ...
                                                    <td className="py-2 px-3 text-right text-amber-900/80 dark:text-amber-200/80">
                                                        {row.opening_balance > 0 ? (
                                                    ...
                                                    <td className="py-2 px-3 text-right">
                                                        <input
                                                            ...
                                                            value={row.deposit}
                                                            onChange={(e) => updateRow(originalIndex, 'deposit', parseFloat(e.target.value) || 0)}
                                                            className="w-24 px-2 py-1 bg-white dark:bg-slate-950/70 border border-amber-200 dark:border-amber-500/30 rounded text-right text-cyan-600 dark:text-cyan-400 font-semibold text-xs shadow-2xs"
                                                        />
                                                    </td>
                                                    <td className="py-2 px-3 text-right">
                                                        <input
                                                            ...
                                                            value={row.withdrawal}
                                                            onChange={(e) => updateRow(originalIndex, 'withdrawal', parseFloat(e.target.value) || 0)}
                                                            className="w-24 px-2 py-1 bg-white dark:bg-slate-950/70 border border-amber-200 dark:border-amber-500/30 rounded text-right text-rose-600 dark:text-rose-400 font-semibold text-xs shadow-2xs"
                                                        />
                                                    </td>
                                                    <td className="py-2 px-3 text-right">
                                                        <input
                                                            ...
                                                            value={row.rate_of_interest}
                                                            onChange={(e) => updateRow(originalIndex, 'rate_of_interest', parseFloat(e.target.value) || 0)}
                                                            className="w-16 px-1.5 py-1 bg-white dark:bg-slate-950/70 border border-amber-200 dark:border-amber-500/30 rounded text-right text-slate-800 dark:text-slate-300 text-xs shadow-2xs"
                                                        />
                                                    </td>
                                                    <td className="py-2 px-3 text-right text-slate-900 dark:text-amber-200 font-semibold">
                                                        ₹ {Number(row.progressive_balance).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                                    </td>
                                                    <td className="py-2 px-3 text-right">
                                                        {row.is_delay_capped ? (
                                                            <div className="flex flex-col items-end">
                                                                <span className="text-rose-500 line-through text-[10px]">
                                                                ...
                                                                <span className="text-[9px] text-rose-500 dark:text-rose-400/80 font-sans">
                                                                    Capped (Rule 11(4))
                                                                </span>
                                                            </div>
                                                        ) : (
                                                    ...
                                                    <td className="py-2 px-3 text-center">
                                                        <button
                                                            ...
                                                            className="px-2 py-1 rounded bg-rose-50 dark:bg-rose-500/10 hover:bg-rose-100 dark:hover:bg-rose-500/25 text-rose-700 dark:text-rose-300 border border-rose-200 dark:border-rose-500/30 text-[10px] font-sans font-semibold transition inline-flex items-center gap-1 shadow-2xs"
                                    ...
                                    {/* Delay Totals Footer */}
                                    <tfoot className="bg-amber-50/80 dark:bg-amber-950/40 font-mono font-bold border-t border-amber-200 dark:border-amber-500/30 text-amber-900 dark:text-amber-200">
                                        <tr>
                                            <td className="py-3 px-3 uppercase text-[11px]">
                                                DELAY PERIOD TOTALS
                                            </td>
                                            <td className="py-3 px-3 text-right text-amber-800 dark:text-amber-300">
                                            ...
                                            <td className="py-3 px-3 text-right text-amber-700 dark:text-amber-400 text-sm font-extrabold">
                                                ₹ {Number(liveCalculations.delay_summary.total_delay_interest).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                            </td>
                                            <td colSpan={2} className="py-3 px-2 text-center text-emerald-600 dark:text-emerald-400">
                                                ✓
                                            </td>
                                        </tr>
                                    </tfoot>
                        ...
                        <div className="glass-panel app-card p-4.5 rounded-2xl border border-amber-200 dark:border-amber-500/20 bg-white dark:bg-amber-950/10 shadow-sm">
                            <div className="text-xs font-bold text-amber-800 dark:text-amber-300 uppercase tracking-wider mb-2 font-mono flex items-center gap-1.5">
                                <Clock className="w-3.5 h-3.5" />
                                <span>Delay Period Audit Breakdown</span>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-5 gap-3 text-xs font-mono">
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 shadow-2xs">
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 font-sans">Opening (Pre-Delay)</div>
                                    <div className="text-sm font-bold text-slate-900 dark:text-white mt-0.5">
                                        ₹ {Number(liveCalculations.delay_summary.opening_balance).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                    </div>
                                </div>
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 shadow-2xs">
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 font-sans">Excess Deposits</div>
                                    <div className="text-sm font-bold text-cyan-600 dark:text-cyan-400 mt-0.5">
                                        ₹ {Number(liveCalculations.delay_summary.total_deposit).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                    </div>
                                </div>
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 shadow-2xs">
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 font-sans">Delay Withdrawals</div>
                                    <div className="text-sm font-bold text-rose-600 dark:text-rose-400 mt-0.5">
                                        ₹ {Number(liveCalculations.delay_summary.total_withdrawal).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                    </div>
                                </div>
                                <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 shadow-2xs">
                                    <div className="text-[10px] text-slate-500 dark:text-slate-400 font-sans">Delayed Interest</div>
                                    <div className="text-sm font-bold text-amber-700 dark:text-amber-400 mt-0.5">
                                        ₹ {Number(liveCalculations.delay_summary.total_delay_interest).toLocaleString('en-IN', { minimumFractionDigits: 2 })}
                                    </div>
                                </div>
                                <div className="p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-500/30 shadow-2xs">
                                    <div className="text-[10px] text-emerald-800 dark:text-emerald-300 font-sans">Final Delay Balance</div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="glass-panel app-card p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 space-y-4 shadow-sm">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2.5">
                                <ShieldCheck className="w-5 h-5 text-amber-600 dark:text-amber-400" />
                                <h4 className="text-sm font-bold text-slate-900 dark:text-white">Deposit-Linked Insurance Scheme (DLIS)</h4>
                            </div>
                            <label className="flex items-center gap-2 cursor-pointer text-xs text-slate-700 dark:text-slate-300 font-medium">
                                <input
                                    ...
                                    className="rounded bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 text-amber-500 focus:ring-0 shadow-2xs"
                                />
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">
                            ...
                            <strong className="text-amber-700 dark:text-amber-300">₹ 60,000.00</strong>.
                        </p>
                        {dlisAdmissible && (
                            <div className="p-3.5 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 flex items-center justify-between shadow-2xs">
                                <div>
                                    <div className="text-xs font-semibold text-amber-800 dark:text-amber-300">Sanctioned DLIS Amount</div>
                                    <div className="text-[11px] text-amber-700/80 dark:text-amber-400/80">36-month progressive balance average</div>
                                </div>
                    ...
                    <div className="glass-panel app-card p-5 rounded-2xl border border-slate-200 dark:border-slate-800/80 bg-white dark:bg-slate-900/80 space-y-3 shadow-sm">
                        ...
                        <div className="space-y-2 text-xs font-mono">
                            ...
                            <div className="flex justify-between py-1 border-b border-slate-100 dark:border-slate-800 text-slate-800 dark:text-slate-200 font-semibold">
                            ...
                            <div className="flex justify-between pt-2 text-sm font-bold text-emerald-700 dark:text-emerald-400">
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                onClick={submit}
                                disabled={processing}
                                className="w-full py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-bold transition shadow-md shadow-indigo-600/30 flex items-center justify-center gap-2"
                            >
                                <Save className="w-4 h-4" />
