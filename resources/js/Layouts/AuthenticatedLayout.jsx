    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans transition-colors duration-200">
            ...
            >
                <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <button
                        ...
                        className="p-1.5 rounded-xl text-slate-600 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-200/60 dark:hover:bg-slate-800/60 transition group"
                    ...
                    <Link href="/" className="flex items-center gap-2 group">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-500 dark:text-slate-400 hidden sm:block truncate max-w-sm">
                                {office_name}
                            </p>
                        </div>
                    </Link>
                ...
                <div className="flex items-center gap-1.5 sm:gap-2.5">
                    ...
                    <button
                        ...
                        className="hidden md:flex items-center gap-2 px-2.5 py-1 rounded-xl bg-slate-200/50 dark:bg-slate-800/60 hover:bg-slate-200/80 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 text-xs border border-slate-300/60 dark:border-slate-700/60 transition shadow-xs"
                        title="Search dockets or press Ctrl+K"
                    >
                        <Search className="w-3.5 h-3.5 text-slate-500 dark:text-slate-400" />
                        <span className="text-[11px] font-medium">Quick Search</span>
                        <kbd className="inline-flex items-center gap-0.5 px-1.5 py-0.2 text-[9px] font-mono bg-white dark:bg-slate-900 rounded border border-slate-300 dark:border-slate-700 text-slate-500 dark:text-slate-400">
                            <Command className="w-2.5 h-2.5" /> K
                        </kbd>
                    </button>

                    {/* Live Clock */}
                    <div className="hidden lg:flex items-center gap-1.5 text-[11px] text-slate-600 dark:text-slate-400 bg-slate-200/50 dark:bg-slate-800/50 px-2.5 py-1 rounded-xl border border-slate-300/50 dark:border-slate-700/50">
                    ...
                    {auth?.user?.is_super_admin && auth?.pending_users_count > 0 && (
                        <Link
                            ...
                            className="hidden sm:flex items-center gap-1 px-2 py-0.8 rounded-xl bg-amber-500/15 border border-amber-500/30 text-amber-700 dark:text-amber-300 text-[11px] font-medium hover:bg-amber-500/25 transition animate-pulse"
                    ...
                    <button
                        ...
                        className="p-1.5 rounded-xl text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 hover:bg-slate-200/60 dark:hover:bg-slate-800/60 transition"
                    ...
                    {/* User Profile Link */}
                    <div className="flex items-center gap-1.5 sm:gap-2.5 pl-1.5 sm:pl-2.5 border-l border-slate-300/60 dark:border-slate-800">
                        <Link
                            href="/profile"
                        ...
                        >
                            ...
                            <div className="w-8 h-8 rounded-full bg-indigo-50 dark:bg-slate-800 border border-indigo-200 dark:border-slate-700 flex items-center justify-center text-xs font-bold text-indigo-700 dark:text-indigo-300 group-hover:border-indigo-500 transition shadow-xs">
            ...
            <div className="flex flex-1 pt-14 relative">
                ...
                <aside
                    className={`fixed top-14 bottom-0 left-0 z-30 transition-all duration-300 flex flex-col border-r border-slate-200/80 dark:border-slate-800/80 bg-white/95 dark:bg-slate-900/90 backdrop-blur-md overflow-y-auto ${
                ...
                >
                    ...
                    {sidebarOpen && (
                        <div className="p-3 m-2 rounded-xl bg-slate-100/80 dark:bg-slate-950/60 border border-slate-200/80 dark:border-slate-800/80 text-[10px] text-slate-600 dark:text-slate-400 space-y-1">
