<?php
$pageName = "Application share holder entry";
...
if (isset($_REQUEST['regd_no'])) {
    ...
    if (isset($_REQUEST['save_app_share_holder'])) {
        ...
        if (($shareHolderNameErr == "") && ($personalAddressErr == "") && ($shareHolderRelationErr == "")) {
            ...
            $slNo = sqlSerialNo($connection, "GPF_ACCOUNT_SHARE_HOLDERS", "SL_NO");
            $applicationCudQuery = "INSERT INTO GPF_ACCOUNT_SHARE_HOLDERS VALUES('$slNo','$registrationNo','$seriesCode', '$accountNumber',
            '$shareHolderName', '$shareHolderRelation', '$personalAddress', '$loginUser',SYSDATE,'$loginUser',SYSDATE)";

            if (sqlCUDData($connection, $applicationCudQuery)) {
                $error = 0;
        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <desgTitle id="main-content">
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="view_application_share_holders.php?regd_no=<?php echo $registrationNo; ?>">
