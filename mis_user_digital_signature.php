<?php
$pageName = "Digital signature report (user wise)";
            ...
            <section id="main-content">
                ...
                if (isset($_REQUEST['generate_report'])) {
                    ...
                    if (($fromDateErr == "") && ($toDateErr == "") && ($signatureErr == "")) {
                        ...
                        a.FP_SIGNED_DATE, a.LTA_SIGNED_DATE, e.FULL_NAME FROM GPF_CASE_STATUS a INNER JOIN GPF_APPLICATION b ON a.REGD_NO=b.REGD_NO 
                        INNER JOIN VLCS.MM_GPF_SERIES c ON a.SERIES_ID=c.SERIES_ID INNER JOIN GPF_AUTHORITY_SIGN d ON b.REGD_NO=d.REGD_NO
                        INNER JOIN USER_ACCOUNTS e ON d.SIGNED_BY=e.USERNAME WHERE TO_DATE(a.FP_SIGNED_DATE) BETWEEN '$fromDate' AND '$toDate'
                        OR TO_DATE(a.LTA_SIGNED_DATE) BETWEEN '$fromDate' AND '$toDate' ORDER BY e.FULL_NAME, a.FP_SIGNED_DATE, a.LTA_SIGNED_DATE";
                                            ...
                                            <div id="printArea">
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 60%; text-align:left;">
                                                            No. MIS / FP / Digital Signed Cases / User-wise / <?php echo $count; ?>
                                                        </td>
                                                ...
                                                <div style="text-align:justify; line-height:1.8em; padding:10px;">
                                                    <div style="font-weight: bold; text-align:center;">
                                                        GPF Final Payment Signed Cases (User wise)
                                                        <br />
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $fetchList['FP_SIGNED_DATE'] == "" ? $fetchList['LTA_SIGNED_DATE'] : date("d/m/Y", strtotime($fetchList['FP_SIGNED_DATE'])); ?></td>
...
<script type="text/javascript">
    const download = () => {
        ...
        let authorityData = {
            ...
            Authority: authority,
            AuthorityType: "user_signed_cases"
        }
        jQuery.ajax({
            type: 'POST',
