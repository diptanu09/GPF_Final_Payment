<?php
$pageName = "Digital signature report";
            ...
            <section id="main-content">
                ...
                if (isset($_REQUEST['generate_report'])) {
                    ...
                    if (($fromDateErr == "") && ($toDateErr == "") && ($signatureErr == "")) {
                        ...
                        a.FP_SIGNED_DATE, a.LTA_SIGNED_DATE, b.DDO_CODE, d.DDO_DESG, b.TREASURY_CODE, e.TRES_NAME FROM GPF_CASE_STATUS a INNER JOIN GPF_APPLICATION b ON a.REGD_NO=b.REGD_NO 
                        INNER JOIN VLCS.MM_GPF_SERIES c ON a.SERIES_ID=c.SERIES_ID INNER JOIN VLCS.STATE_DDO d ON b.DDO_CODE=d.DDO_CODE
                        INNER JOIN VLCS.STATE_TREASURY e ON b.TREASURY_CODE=e.TRES_CODE WHERE TO_DATE(a.FP_SIGNED_DATE) BETWEEN '$fromDate' AND '$toDate'
                        OR TO_DATE(a.LTA_SIGNED_DATE) BETWEEN '$fromDate' AND '$toDate' ORDER BY a.FP_SIGNED_DATE, a.LTA_SIGNED_DATE";
                                            ...
                                            <div id="printArea">
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 60%; text-align:left;">
                                                            No. MIS / FP / Signed cases / <?php echo $count; ?>
                                                        </td>
                                                ...
                                                <div style="text-align:justify; line-height:1.8em; padding:10px;">
                                                    <div style="font-weight: bold; text-align:center;">
                                                        GPF Final Payment Signed Cases
                                                        <br />
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $fetchList['FP_SIGNED_DATE'] == "" ? date("d/m/Y", strtotime($fetchList['LTA_SIGNED_DATE'])) : date("d/m/Y", strtotime($fetchList['FP_SIGNED_DATE'])); ?></td>
                                                                    <td><?php echo $fetchList['DDO_CODE']; ?></td>
                                                                    <td><?php echo $fetchList['DDO_DESG']; ?></td>
                                                                    <td><?php echo $fetchList['TREASURY_CODE']; ?></td>
