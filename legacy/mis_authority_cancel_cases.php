<?php
$pageName = "Authority cancel report";
            ...
            <section id="main-content">
                ...
                if (isset($_REQUEST['generate_report'])) {
                    ...
                    if (($fromDateErr == "") && ($toDateErr == "") && ($signatureErr == "")) {
                        ...
                        b.CREATE_MODIFY_DATE, b.REMARKS FROM GPF_CASE_STATUS a INNER JOIN GPF_CASES_REMARKS b ON a.REGD_NO=b.REGD_NO 
                        INNER JOIN VLCS.MM_GPF_SERIES c ON a.SERIES_ID=c.SERIES_ID WHERE b.REMARKS_TYPE='DS' AND 
                        TO_DATE(b.CREATE_MODIFY_DATE) BETWEEN '$fromDate' AND '$toDate' ORDER BY b.CREATE_MODIFY_DATE";
                                            ...
                                            <div id="printArea">
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 60%; text-align:left;">
                                                            No. MIS / FP / Authority cancel cases / <?php echo $count; ?>
                                                        </td>
                                                ...
                                                <div style="text-align:justify; line-height:1.8em; padding:10px;">
                                                    <div style="font-weight: bold; text-align:center;">
                                                        GPF Final Payment Authority Cancel Cases
                                                        <br />
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo date("d/m/Y", strtotime($fetchList['CREATE_MODIFY_DATE'])); ?></td>
...
<script type="text/javascript">
    const download = () => {
        ...
        let authorityData = {
            ...
            Authority: authority,
            AuthorityType: "authority_cancel"
        }
        jQuery.ajax({
            type: 'POST',
