            ...
            <section id="main-content">
                ...
                if (isset($_REQUEST['generate_report'])) {
                    ...
                    if (($fromDateErr == "") && ($toDateErr == "") && ($signatureErr == "")) {
                        $sql = "SELECT a.SL_NO, a.REGD_NO, 'T/'||d.SERIES_DESCR||'/'||a.ACCOUNT_NO GPF_ACC_NO, a.SUBSCRIBER_NAME,
                        a.CANCELED_DATE, c.REMARKS FROM GPF_CASE_STATUS a INNER JOIN GPF_INWARD b ON a.REGD_NO=b.REGD_NO 
                        INNER JOIN GPF_CASES_REMARKS c ON a.REGD_NO=c.REGD_NO INNER JOIN VLCS.MM_GPF_SERIES d
                        ON a.SERIES_ID=d.SERIES_ID WHERE a.CASE_STATUS=11 AND TO_DATE(a.CANCELED_DATE) BETWEEN '$fromDate' AND '$toDate'
                        ORDER BY a.SL_NO";
                                            ...
                                            <div id="printArea">
                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="width: 60%; text-align:left;">
                                                            No. MIS / FP / Cancel cases / <?php echo $count; ?>
                                                        </td>
                                                ...
                                                <div style="text-align:justify; line-height:1.8em; padding:10px;">
                                                    <div style="font-weight: bold; text-align:center;">
                                                        GPF Final Payment Cancel Cases
                                                        <br />
