   <?php
    $pageName = "Objection / Minus balance";
                                               ...
                                               <?php
                                                ...
                                                ?>
                                                   <tr>
                                                       ...
                                                       <td>
                                                           <a href="minus_balance_report.php?regd_no=<?php echo $fetchLists['REGD_NO']; ?>">
                                                               <button class="btn btn-primary">MINUS BALANCE</button>
                                                           </a>
                                                           <a href="objection_report.php?regd_no=<?php echo $fetchLists['REGD_NO']; ?>">
                                                               <button class="btn btn-info">OBJECTION</button>
                                                           </a>
                                                       </td>
                                                   </tr>
                                               <?php
